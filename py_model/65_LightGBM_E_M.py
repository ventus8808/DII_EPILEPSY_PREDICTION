...
def main():
    ...
    # Load the model
    model_name = "LightGBM"
    with open(f'/Users/maguoli/Documents/Development/Predictive/Models/65_{model_name}_model.pkl', 'rb') as f:
        model = pickle.load(f)
    ...
    ece, mce, bin_metrics, hl_stat, p_value = calculate_calibration_metrics(y_test, y_prob, weights_test)
    ...
    metrics_file_path = '/Users/maguoli/Documents/Development/Predictive/Model metrics/65_LightGBM_metrics.json'
