...
def main():
    ...
    parser = argparse.ArgumentParser(description="PSGD(多项式特征SGD)模型评估与可视化")
    ...
    if draw_learning:
        ...
        try:
            ...
            print(f"绘制学习曲线时出错: {e}，PSGD模型可能不支持某些学习曲线特性")
            import traceback
            traceback.print_exc()
