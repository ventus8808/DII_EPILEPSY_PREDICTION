...
# 不再使用单独目录，直接使用model_dir
ensemble_dir = model_dir
...
def main():
    ...
    try:
        ...
        param_path = ensemble_dir / 'Voting_best_params.json'
        ...
        with open(ensemble_dir / 'Voting_feature_info.json', 'w') as f:
        ...
        # 保存测试集指标
        test_metrics_path = output_dir / 'Voting_metrics.json'
